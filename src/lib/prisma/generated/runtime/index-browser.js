...
var Oe = (e, n) => {
  ...
  xe = (e, n, i, t) => {
    if ((n && typeof n == 'object') || typeof n == 'function')
      for (let r of Ke(n)) !Qe.call(e, r) && r !== i && pe(e, r, { get: () => n[r], enumerable: !(t = Xe(n, r)) || t.enumerable });
    return e;
  };
...
h.toExponential = function (e, n) {
  var i,
    ...
    r = t.constructor;
  return (
    e === void 0 ? (i = L(t, !0)) : (q(e, 0, H), n === void 0 ? (n = r.rounding) : q(n, 0, 8), (t = p(new r(t), e + 1, n)), (i = L(t, !0, e + 1))),
...
h.toFraction = function (e) {
  ...
  if (!v) return new N(g);
  if (
    ((f = i = new N(1)), (t = c = new N(0)), (n = new N(t)), (s = n.e = $e(v) - g.e - 1), (o = s % m), (n.d[0] = C(10, o < 0 ? m + o : o)), e == null)
  )
    e = s > 0 ? n : f;
  else {
    ...
    n > c.maxE + 1 || n < c.minE - 1
      ...
      : ((w = !1),
        ...
        r.d &&
          ((r = p(r, t + 5, 1)),
          Q(r.d, t, s) &&
            ((n = t + 10), (r = p(be(e.times(B(u, n + i)), n), n + 5, 1)), +b(r.d).slice(t + 1, t + 15) + 1 == 1e14 && (r = p(r, t + 1, 0)))),
        (r.s = o),
        (w = !0),
        (c.rounding = s),
        p(r, t, s))
...
function pn(e, n) {
  ...
  ((t = n.d.length),
    t < 32 ? ((i = Math.ceil(t / 3)), (r = (1 / le(4, i)).toString())) : ((i = 16), (r = '2.3283064365386962890625e-10')),
    (e.precision += i),
...
function gn(e, n) {
  ...
  return s < 0
    ? new t(e.s * 0)
    : ((e.e = ce(f, l)), (e.d = f), (w = !1), o && (e = k(e, r, u * 4)), c && (e = e.times(Math.abs(c) < 54 ? C(2, c) : Y.pow(2, c))), (w = !0), e);
}
function mn(e, n) {
  var i,
    t = n.d.length;
