...
export default function JobsList({ setStatus, providedJobs }: { setStatus: any; providedJobs?: Job[] }) {
    ...
    const LoadingScreen = () => (
        <div className="flex items-center justify-center min-h-[300px] px-6 py-8">
        ...
        <div className="text-center py-16 px-6">
            <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V4a2 2 0 00-2-2H8a2 2 0 00-2 2v2m8 0h2a2 2 0 012 2v8a2 2 0 01-2 2H6a2 2 0 01-2-2V8a2 2 0 012-2h2" />
                </svg>
            </div>
            <h3 className="mb-2 text-2xl font-bold text-gray-900">No Jobs Available Yet</h3>
            <p className="text-gray-600 text-lg mb-8 max-w-md mx-auto">Be the first to discover amazing opportunities! New jobs are posted regularly.</p>
            <button className="rounded-full bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-3 text-white font-semibold transition-all duration-300 hover:scale-105">Check Back Soon</button>
        </div>
    );
