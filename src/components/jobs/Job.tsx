...
export default function JobCard({ job, setStatus }: { job: Job; setStatus: any }) {
    ...
    return (
        <div 
            className="group relative overflow-hidden rounded-2xl border border-gray-200/50 bg-white p-6 shadow-lg transition-all duration-300 hover:scale-[1.01] hover:shadow-xl mb-6"
        ...
        >
            ...
            <div className="relative z-10 mb-6 flex items-start justify-between">
                <div className="flex-1 pr-4">
                    <h2 className="mb-1 text-xl font-bold tracking-tight text-gray-900 transition-all duration-300">
                        {job.title}
                    </h2>
                </div>
                <span 
            ...
            {/* Description */}
            <p className="relative z-10 mb-6 leading-relaxed text-gray-600 line-clamp-3">
                {job.description}
            </p>
            ...
            <div className="relative z-10">
                {loading ? (
                    <div className="flex items-center justify-center rounded-xl bg-gray-100 py-3 px-6">
                    ...
                    <button
                        onClick={apply}
                        disabled={isApplying}
                        className={`group/button relative w-full overflow-hidden rounded-xl py-3 px-6 font-bold text-white shadow-lg transition-all duration-300 hover:scale-[1.02] hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-70 disabled:hover:scale-100 ${
                            isApplying 
                    ...
                    >
                        ...
                        <span className="relative flex items-center justify-center">
                            {isApplying ? (
                                ...
                                <>
                                    <svg className="mr-2 h-4 w-4 transition-transform duration-300 group-hover/button:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
