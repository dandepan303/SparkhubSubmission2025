...
export default function Inventory({ userId }: { userId: string }) {
  ...
  useEffect(() => {
    ...
    loadOfferings();
  }, [session.loading, profile.loading, loadOfferings]);
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 py-8">
              ...
              <form onSubmit={handleCreateOffering} className="space-y-6">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl border border-gray-300 bg-white/90 px-4 py-3 text-gray-900 shadow-sm transition-all duration-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none"
                    rows={3}
                    required
                  />
                </div>
                ...
                <div className="flex gap-4">
                  <button
                    type="submit"
                    className="flex-1 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-3 font-bold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:from-blue-700 hover:to-purple-700">
                    Create Offering
                  </button>
                  <button
                    type="button"
        ...
        {offerings.length > 0 ? (
          ...
          <div className="py-16 text-center">
            ...
            <button
              onClick={() => setShowCreateForm(true)}
              className="rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-3 font-bold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:from-blue-700 hover:to-purple-700">
